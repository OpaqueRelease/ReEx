...
parser.add_argument('--intersection_ratio',default=0.01, type = float)
parser.add_argument('--cluster_intersection_ratio',default=0.5, type = float)
parser.add_argument('--depth_weight',default=0.4, type = float)
parser.add_argument('--cluster_depth_weight',default=5, type = float)
...
parser.add_argument('--step',default=0.97, type = float)
