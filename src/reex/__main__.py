...
if args.reasoner == 'selective_staircase':
    ...
    outjson = generalize_ancestry(ontology_graph, explanations = explanations, attributes = attributes, test_run = False,  abs = args.absolute, depthWeight = args.depth_weight, gene_to_onto_map = gene_to_onto_map, print_results = args.results)
    scores = compute_all_scores(outjson, ontology_graph, args.mapping_file)
